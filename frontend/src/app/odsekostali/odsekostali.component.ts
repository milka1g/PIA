...
@Component({
  selector: 'app-odsekostali',
  templateUrl: './odsekostali.component.html',
  styleUrls: ['./odsekostali.component.css']
})
export class OdsekostaliComponent implements OnInit {
  ...
  ngOnInit(): void {
    //alert("pravim");
    this.predmetiService.dohvatiSvePredmeteSmera("ostali").subscribe((preds:Predmet[])=>{
      this.predmeti = preds;
